<template>
  <div class="container mx-auto p-8">
    <p class="text-3xl font-bold mb-6 text-gray-800">Aviso de Privacidad</p>
    ...
    <!-- Sección 1 -->
    <p class="text-2xl font-semibold mb-4 mt-6 text-gray-800">1. Datos Personales Recabados</p>
    <p class="mb-4 text-gray-700">
    ...
    <!-- Sección 2 -->
    <p class="text-2xl font-semibold mb-4 mt-6 text-gray-800">2. Finalidades del Tratamiento de Datos Personales</p>
    <p class="mb-4 text-gray-700">
      Sus datos personales serán utilizados para las siguientes finalidades:
    </p>
    <p class="text-xl font-medium mb-2 mt-4 text-gray-800">Finalidades Primarias (Necesarias para la prestación del servicio):</p>
    <ul class="list-disc list-inside mb-4 text-gray-700">
    ...
    <p class="text-xl font-medium mb-2 mt-4 text-gray-800">Finalidades Secundarias (No esenciales, pero que nos permiten mejorar nuestros servicios):</p>
    <ul class="list-disc list-inside mb-4 text-gray-700">
    ...
    <!-- Sección 3 -->
    <p class="text-2xl font-semibold mb-4 mt-6 text-gray-800">3. Transferencia de Datos Personales</p>
    <p class="mb-4 text-gray-700">
    ...
    <!-- Sección 4 -->
    <p class="text-2xl font-semibold mb-4 mt-6 text-gray-800">4. Medios para Ejercer los Derechos ARCO (Acceso, Rectificación, Cancelación y Oposición)</p>
    <p class="mb-4 text-gray-700">
      Usted tiene derecho a conocer qué datos personales tenemos de usted, para qué los utilizamos y las condiciones del uso que les damos (Acceso). Asimismo, es su derecho solicitar la corrección de su información personal en caso de que esté desactualizada, sea inexacta o incompleta (Rectificación); que la eliminemos de nuestros registros o bases de datos cuando considere que la misma no está siendo utilizada adecuadamente (Cancelación); así como oponerse al uso de sus datos personales para fines específicos (Oposición).
    </p>
    <p class="mb-4 text-gray-700">
      Para ejercer cualquiera de estos derechos ARCO, usted deberá enviar su solicitud por escrito a la siguiente dirección de correo electrónico: <strong>contacto@parteluzarquitectura.com</strong>. Su solicitud deberá incluir:
    </p>
    <ul class="list-disc list-inside mb-4 text-gray-700">
    ...
    <!-- Sección 5 -->
    <p class="text-2xl font-semibold mb-4 mt-6 text-gray-800">5. Medios para Revocar el Consentimiento</p>
    <p class="mb-4 text-gray-700">
    ...
    <!-- Sección 6 -->
    <p class="text-2xl font-semibold mb-4 mt-6 text-gray-800">6. Opciones y Medios para Limitar el Uso o Divulgación de los Datos</p>
    <p class="mb-4 text-gray-700">
      Adicionalmente al ejercicio de los derechos ARCO, usted puede limitar el uso y divulgación de sus datos personales, por ejemplo, para no recibir comunicaciones de marketing, enviando su solicitud a la dirección de correo electrónico <strong>contacto@parteluzarquitectura.com</strong>.
    </p>

    <!-- Sección 7 -->
    <p class="text-2xl font-semibold mb-4 mt-6 text-gray-800">7. Uso de Cookies y Tecnologías de Rastreo</p>
    <p class="mb-4 text-gray-700">
    ...
    <!-- Sección 8 -->
    <p class="text-2xl font-semibold mb-4 mt-6 text-gray-800">8. Cambios al Presente Aviso de Privacidad</p>
    <p class="mb-4 text-gray-700">
    ...
    <p class="text-right text-sm text-gray-600 mt-8">
...
<script setup>
// No se requiere lógica JS para este aviso
</script>